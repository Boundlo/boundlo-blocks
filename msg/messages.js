...
// Control blocks
Blockly.Msg.CONTROL_UNLESSELSEREPORTER = 'unless %1 then %2 else %3';
Blockly.Msg.CONTROL_IFELSEREPORTER = 'if %1 then %2 else %3';
Blockly.Msg.CONTROL_ERRORREPORTER = 'error';
Blockly.Msg.CONTROL_THROWERROR = 'throw %1 error %2';
Blockly.Msg.CONTROL_THROWERROR_NORMAL = 'normal';
Blockly.Msg.CONTROL_THROWERROR_FATAL = 'fatal';
Blockly.Msg.CONTROL_WAITATICK = 'wait a tick';
Blockly.Msg.CONTROL_TRYTODO = 'try to do';
Blockly.Msg.CONTROL_TRYTODO_ONBLOCKERROR = 'on block error';
Blockly.Msg.CONTROL_STOPOBJECT = 'stop object %1';
Blockly.Msg.CONTROL_ASOBJECT = 'as %1 do';
Blockly.Msg.CONTROL_ASOBJECT_ORIGINAL = 'original';
Blockly.Msg.CONTROL_ASOBJECT_CLONES = 'clones';
Blockly.Msg.CONTROL_CHANCE = 'chance %1 %';
Blockly.Msg.CONTROL_CHANCE_ONNOT = 'on not';
Blockly.Msg.CONTROL_UNLESS = 'unless %1 then';
Blockly.Msg.CONTROL_RACE = 'race';
Blockly.Msg.CONTROL_RACE_VS = 'vs';
Blockly.Msg.CONTROL_FOREVER = 'forever';
Blockly.Msg.CONTROL_BREAK = 'breakout loop';
Blockly.Msg.CONTROL_CONTINUE = 'continue loop';
Blockly.Msg.CONTROL_CRASH = 'crash page';
Blockly.Msg.CONTROL_REPEAT = 'repeat %1';
Blockly.Msg.CONTROL_RUNIF = 'run if %1';
...
Blockly.Msg.CONTROL_DELETE = 'delete';
Blockly.Msg.CONTROL_DELETE_THISCLONE = 'this clone';
Blockly.Msg.CONTROL_DELETE_OTHERCLONESWITHINPARENT = 'other clones within parent';
Blockly.Msg.CONTROL_DELETE_ALLCLONESIWTHINEXPERIENCE = 'all clones within experience';
Blockly.Msg.CONTROL_DELETE_OTHERCLONESWITHINEXPERIENCE = 'other clones within experience';
Blockly.Msg.CONTROL_WAIT = 'wait %1 seconds';
Blockly.Msg.CONTROL_WAITORUNTIL = 'wait %1 seconds or until %2';
Blockly.Msg.CONTROL_WAITUNTIL = 'wait until %1';
Blockly.Msg.CONTROL_REPEATUNTIL = 'repeat until %1';
Blockly.Msg.CONTROL_WHILE = 'while %1 do';
...
Blockly.Msg.CONTROL_DELETECLONESOF = 'delete clones of %1';
Blockly.Msg.CONTROL_DELETECLONEWITHID = 'delete %1 clone with id %2';
Blockly.Msg.CONTROL_DELETECLONEWITHID_MYOWN = 'my own';
Blockly.Msg.CONTROL_CREATECLONEOF_MYSELF = 'myself';
Blockly.Msg.CONTROL_DELETETHISCLONE = 'delete this clone (DEP)';
Blockly.Msg.CONTROL_RUNFLAG = 'run %1';
Blockly.Msg.CONTROL_ISCLONE = 'clone?';
Blockly.Msg.CONTROL_ISORIGINAL = 'original?';
...
Blockly.Msg.CONTROL_RUNATTURBOMODE = 'run at turbo mode';
Blockly.Msg.CONTROL_NEWTHREAD = 'new thread';
Blockly.Msg.CONTROL_NEWBRANCH = 'new branch';
Blockly.Msg.CONTROL_RUNSIMULTANOUSLY = 'run simultanously';
Blockly.Msg.CONTROL_RUNSIMULTANOUSLY_AND = 'and';
Blockly.Msg.CONTROL_SWITCH = 'switch %1';
Blockly.Msg.CONTROL_SWITCH_DEFAULT = 'default';
Blockly.Msg.CONTROL_CASE = 'case %1';
Blockly.Msg.CONTROL_CASE_BREAK = 'break';
Blockly.Msg.CONTROL_FOREVERIF = 'forever if %1';
Blockly.Msg.CONTROL_CLONEID = 'clone id';
Blockly.Msg.CONTROL_AMOUNTOFALLCLONES = 'amount of all clones';
Blockly.Msg.CONTROL_AMOUNTOFMYCLONES = 'amount of my clones';
Blockly.Msg.CONTROL_INCRCOUNTERBY = 'increment counter by %1';
Blockly.Msg.CONTROL_DECRCOUNTERBY = 'decrement counter by %1';
Blockly.Msg.CONTROL_MODIFYCOUNTERTO = 'modify counter to %1';
...
Blockly.Msg.EVENT_ALWAYS = 'always %1';
Blockly.Msg.EVENT_EVERY = 'every %1 seconds';
Blockly.Msg.EVENT_NEVER = 'never %1';
...
Blockly.Msg.EVENT_WHENISTRUE = 'when %1 is true';
Blockly.Msg.EVENT_WHILEISTRUE = 'while %1 is true';
...
Blockly.Msg.EVENT_ISBROADCASTRECEIVED= 'broadcast %1 received?';

// Looks blocks
Blockly.Msg.LOOKS_FXTEST = 'color fx test %1';
Blockly.Msg.LOOKS_SAYFORSECS = 'say %1 for %2 seconds';
Blockly.Msg.LOOKS_SAY = 'say %1';
Blockly.Msg.LOOKS_STOPSPEAKING = 'stop speaking';
Blockly.Msg.LOOKS_SAYNOTHING = 'say nothing (DEP)';
Blockly.Msg.LOOKS_HELLO = 'Hello!';
Blockly.Msg.LOOKS_THINKFORSECS = 'think %1 for %2 seconds';
Blockly.Msg.LOOKS_THINK = 'think %1';
Blockly.Msg.LOOKS_THINKNOTHING = 'think nothing (DEP)';
...
Blockly.Msg.LOOKS_NUMBERNAME_LASTNUMBER = 'last (number)';
Blockly.Msg.LOOKS_NUMBERNAME_LASTNAME = 'last (name)';
...
Blockly.Msg.LOOKS_CHANGEVISIBILITYBY = 'change visibility by %1';
Blockly.Msg.LOOKS_SETVISIBILITYTO = 'set visibility to %1 %';
Blockly.Msg.LOOKS_LAYER = 'layer';
Blockly.Msg.LOOKS_TOTALLAYERS = 'total layers';
Blockly.Msg.LOOKS_VISIBLE = 'visible?';
Blockly.Msg.LOOKS_GOTOLAYER = 'go to layer %1';

Blockly.Msg.LOOKS_GOLAYERINFRONTOFBEHINDOBJECT = 'go %1 layer %2 %3';
Blockly.Msg.LOOKS_GOLAYERINFRONTOFBEHINDOBJECT_INFRONTOF = 'in front of';
Blockly.Msg.LOOKS_GOLAYERINFRONTOFBEHINDOBJECT_BEHIND = 'behind';

// Motion blocks
Blockly.Msg.MOTION_ROTATIONSTYLE = 'rotation style';
Blockly.Msg.MOTION_MOVESTEPS = 'move %1 steps';
Blockly.Msg.MOTION_MOVESTEPSINDIRECTION = 'move %1 steps in %2 direction';
...
Blockly.Msg.MOTION_TURNAROUND = 'turn around %1';
...
Blockly.Msg.OPERATORS_MGT = '%1 ≫ %2 (𝓂𝓊𝒸𝒽 is %3)';
Blockly.Msg.OPERATORS_MLT = '%1 ≪ %2 (𝓂𝓊𝒸𝒽 is %3)';
Blockly.Msg.OPERATORS_EQUALS = '%1 = %2';
Blockly.Msg.OPERATORS_NOTEQUALS = '%1 ≠ %2';
Blockly.Msg.OPERATORS_AND = '%1 and %2';
Blockly.Msg.OPERATORS_NAND = '%1 nand %2';
Blockly.Msg.OPERATORS_OR = '%1 or %2';
Blockly.Msg.OPERATORS_NOR = '%1 nor %2';
Blockly.Msg.OPERATORS_XOR = '%1 xor %2';
Blockly.Msg.OPERATORS_XNOR = '%1 xnor %2';
Blockly.Msg.OPERATORS_TO = 'make %1 %2';
...
Blockly.Msg.OPERATORS_IS = 'is %1 %2';

Blockly.Msg.OPERATORS_TONEGATIVE = 'make negative %1';
Blockly.Msg.OPERATORS_TOPOSITIVE = 'make positive %1';
Blockly.Msg.OPERATORS_TOLOWERCASE = 'make lowercase %1';
Blockly.Msg.OPERATORS_TOUPPERCASE = 'make uppercase %1';
Blockly.Msg.OPERATORS_TOSTRING = 'make string %1';
Blockly.Msg.OPERATORS_TONUMBER = 'make number %1';
Blockly.Msg.OPERATORS_TOBOOL = 'make boolean %1';
...
Blockly.Msg.OPERATORS_CASESENSITIVE = 'case sensitive';
...
Blockly.Msg.SENSING_OBJECTNAME = 'object name';
...
Blockly.Msg.SENSING_OS = 'operating system';
Blockly.Msg.SENSING_BROWSER = 'browser';
Blockly.Msg.SENSING_TURBOMODE = 'turbo mode?';
Blockly.Msg.SENSING_LOGGEDIN = 'logged in?';
Blockly.Msg.SENSING_SETTURBOMODE = 'set turbo mode %1';
...
Blockly.Msg.SENSING_SENSOR = '%1 sensor value';
...
Blockly.Msg.SENSING_SENSORPRESSED = 'sensor %1 ?';
...
Blockly.Msg.SENSING_BEHIND = 'behind %1 ?';
